    ...
    <>
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <Link href="https://wa.me/55XXXXXXXXXX" className="flex flex-col items-center text-center p-8 bg-[#111] border border-white/5 rounded-2xl hover:bg-[#1a1a1a] transition-all group hover:-translate-y-2 shadow-lg">
             ...
             <p className="text-gray-400 group-hover:text-white transition-colors">(XX) XXXX-XXXX</p>
          </Link>
             <a href="https://wa.me/557999914079" target="_blank" className="text-gray-400 group-hover:text-white transition-colors">
                (79) 99914-079
             </a>
          </div>
